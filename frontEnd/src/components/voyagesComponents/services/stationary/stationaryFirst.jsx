    ...
    fetch(`${BASE_URL}/voyager/get-stationary-item`, {
      ...
      .then((data) => {
        if (Array.isArray(data)) {
          setStationaryItems(data); // ✅ Good case
        } else {
          console.error("Expected an array, got:", data);
          setStationaryItems([]); // Fallback to empty array
        }
      })
    ...
    <section className="py-16 px-4 md:px-16">
      ...
      >
        ...
        <motion.h1
          ...
          custom={1}
        >
          Welcome to <span className="text-purple-500">Aurelia </span>{" "}
          Stationery Services
        </motion.h1>
        ...
        >
          {stationaryItems.map((item, i) => (
            ...
            >
              ...
              <p className="text-lg font-medium text-green-500">{item.price}</p>
