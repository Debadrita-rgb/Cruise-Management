...
const ManagerNavbar = ({ toggleSidebar, isSidebarOpen }) => {
    ...
    const fetchManagerDetails = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:5000/manager/showname_navbar",
          {
  ...
  const getPageTitle = () => {
    ...
    if (
      location.pathname.startsWith(
        "/manager/services/stationary/editStationary/"
      )
    ) {
    ...
    switch (location.pathname) {
      case "/manager/facilities":
        return "Facilities";
      case "/manager/profile":
        return "Manager Profile";
      case "/manager/services/catering":
        return "View Catering";
      case "/manager/services/catering/addCatering":
        return "Add Catering";

      case "/manager/services/stationary":
        return "View Stationary";
      case "/manager/services/stationary/addStationary":
