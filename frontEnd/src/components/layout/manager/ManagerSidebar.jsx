...
export default function ManagerSidebar({ isOpen, toggleSidebar }) {
          ...
          <div>
            ...
            >
              <span className="flex items-center space-x-2">
                <FaGift /> <span>Manage Bookings</span>
              </span>
            ...
            {openDropdown && (
              <div className="ml-6 mt-2 space-y-2 text-sm">
                <Link
                  to="/manager/bookings/bookedMovies"
                  className="block p-2 rounded hover:bg-gray-200 hover:text-[#1b4c6d]"
                >
                  View Booked Resort / Movie Tickets
                </Link>
                <Link
                  to="/manager/bookings/bookedSalon"
                  className="block p-2 rounded hover:bg-gray-200 hover:text-[#1b4c6d]"
                >
                  View Booked Beauty Salon
                </Link>
                <Link
                  to="/manager/bookings/bookedFitness"
                  className="block p-2 rounded hover:bg-gray-200 hover:text-[#1b4c6d]"
                >
                  View booked fitness center
                </Link>
                <Link
                  to="/manager/bookings/bookedPartyhall"
                  className="block p-2 rounded hover:bg-gray-200 hover:text-[#1b4c6d]"
                >
